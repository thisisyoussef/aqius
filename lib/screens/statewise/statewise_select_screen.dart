...
import 'package:aqius/screens/statewise/statewise_screen.dart';
import 'package:aqius/screens/timepollutant/tp_screen.dart';
import 'package:aqius/wide_rounded_button.dart';
import 'package:flutter/material.dart';
import 'package:dropdown_search/dropdown_search.dart';

class StatewiseSelectScreen extends StatefulWidget {
  const StatewiseSelectScreen({Key? key}) : super(key: key);

  @override
  State<StatewiseSelectScreen> createState() => _StatewiseSelectScreenState();
}

class _StatewiseSelectScreenState extends State<StatewiseSelectScreen> {
  late String state;
            ...
            WideRoundedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => StatewiseScreen(),
                      ));
                })
          ],
        ),
