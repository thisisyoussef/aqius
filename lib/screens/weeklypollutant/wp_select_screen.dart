...
import 'package:aqius/screens/weeklypollutant/wp_screen.dart';
import 'package:aqius/wide_rounded_button.dart';
import 'package:flutter/material.dart';
import 'package:dropdown_search/dropdown_search.dart';

class WPSelectScreen extends StatefulWidget {
  const WPSelectScreen({Key? key}) : super(key: key);

  @override
  State<WPSelectScreen> createState() => _WPSelectScreenState();
}

class _WPSelectScreenState extends State<WPSelectScreen> {
  late String state;
